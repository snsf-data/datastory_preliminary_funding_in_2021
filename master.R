...
datastory_name <- "preliminary_funding_in_2021"
...
# characters etc.)
datastory_name_de <- "882-millionen-franken-fuer-forschung"
datastory_name_en <- "882-million-francs-for-research"
datastory_name_fr <- "882-millions-de-francs-pour-la-recherche"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "882 million francs for research" 
lead_en <- "Initial preliminary figures on SNSF funding in 2021: We invested 882 million francs in new projects, fellowships and publications." 
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "882 Millionen Franken für die Forschung" 
lead_de <- "Erste vorläufige Zahlen zur SNF-Förderung im Jahr 2021: Wir haben 882 Millionen Franken in neue Projekte, Stipendien und Publikationen investiert." 
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "882 millions de francs pour la recherche"
lead_fr <- "Premiers chiffres provisoires concernant le soutien financier du FNS en 2021 : nous avons investi 882 millions de francs dans de nouveaux projets, des bourses et des publications." 
# Contact persons, always (first name + last name)
contact_person <- c("Daniel Schnyder", "Julius Mattern")
...
publication_date <- "2022-02-10 01:00:00"
...
doi <- "10.5281/zenodo.6022479" 
# URL to Github page (optional)
github_url <- "https://github.com/snsf-data/datastory_preliminary_funding_in_2021" 
